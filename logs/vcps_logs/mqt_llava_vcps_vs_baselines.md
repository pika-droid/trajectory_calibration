...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 14.74% | 13.53% | 0.698 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 9.25% | 9.91% | 0.685 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 14.66% | 12.48% | 0.697 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 11.19% | 14.95% | *0.705* | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 7.58% | 11.91% | 0.703 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 8.66% | 11.36% | 0.703 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 2.37% | 6.79% | 0.705 | `SCRAMBLED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.93% | 12.28% | 0.355 | `COLLAPSED` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 2.37% | 6.80% | 0.706 | `SCRAMBLED` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 2.73% | 7.15% | 0.579 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 0.85% | 4.76% | 0.526 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 0.79% | 3.59% | 0.681 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 4.27% | 6.20% | 0.447 | `COLLAPSED` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 0.79% | 3.60% | 0.681 | `VALID` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 0.47% | 4.43% | 0.653 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 0.48% | 4.42% | 0.654 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 13.37% | 13.93% | *0.763* | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 10.87% | 13.20% | 0.762 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 13.59% | 13.94% | **0.763** | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | **7.59%** | 11.45% | 0.758 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 9.36% | 12.55% | 0.758 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 8.80% | 11.40% | 0.759 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 0.33% | 1.09% | 0.920 | `COLLAPSED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 0.80% | 1.79% | 0.136 | `COLLAPSED` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 0.33% | 1.10% | *0.925* | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.69% | 9.07% | 0.607 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 5.19% | 6.98% | 0.605 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 5.69% | 8.07% | 0.607 | `VALID` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 3.37% | 8.40% | 0.568 | `SCRAMBLED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 7.16% | 9.42% | **0.625** | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 9.07% | 10.04% | 0.827 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.19% | 9.46% | 0.828 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 9.88% | 10.11% | 0.827 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 9.69% | 10.13% | 0.830 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 7.56% | 8.13% | 0.828 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 6.46% | 7.66% | 0.829 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 0.14% | 2.03% | 0.712 | `COLLAPSED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 1.15% | 3.15% | 0.574 | `COLLAPSED` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 0.14% | 2.04% | *0.715* | `COLLAPSED` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 0.16% | 2.15% | 0.347 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 0.15% | 2.15% | 0.347 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | **3.85%** | 5.55% | *0.821* | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 5.73% | 5.81% | 0.820 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 4.10% | 5.09% | 0.820 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 5.63% | 6.05% | 0.815 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | *4.03%* | 5.27% | 0.817 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 4.41% | 4.82% | 0.815 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 4.93% | 5.29% | **0.783** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 5.74% | 7.99% | 0.771 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 5.09% | 5.09% | *0.783* | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 9.56% | 10.04% | 0.777 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 6.51% | 5.61% | 0.777 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 4.79% | 5.50% | 0.778 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 6.06% | 9.67% | **0.746** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.45% | 10.14% | 0.727 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 6.10% | 9.65% | **0.746** | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 6.04% | 10.41% | 0.737 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 6.52% | 6.48% | 0.737 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 7.07% | 6.38% | 0.737 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 6.30% | 7.54% | 0.728 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 7.30% | 9.49% | 0.689 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | *6.29%* | 7.54% | 0.728 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 17.86% | 18.05% | 0.686 | `COLLAPSED` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 8.24% | 8.73% | 0.697 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 8.68% | 8.62% | 0.707 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.82% | 6.81% | 0.799 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 4.88% | 5.80% | 0.779 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 5.81% | 6.81% | 0.799 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 28.61% | 28.61% | 0.802 | `COLLAPSED` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 6.15% | 5.82% | 0.803 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 6.07% | 5.18% | 0.803 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 8.69% | 6.67% | 0.786 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.84% | 9.44% | 0.786 | `VALID` |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 7.96% | 6.68% | 0.786 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 11.60% | 12.47% | 0.762 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 12.03% | 11.73% | 0.748 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 10.30% | 11.79% | 0.758 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.87% | 7.26% | 0.755 |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 6.40% | 7.97% | 0.640 |
| Trajectory Platt (5D) | Trajectory Platt Baseline (5D) | Single-Pass ($T=0.0$) | 5.92% | 7.07% | *0.756* |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 22.97% | 23.99% | 0.684 |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 5.36% | 7.11% | 0.699 |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 5.30% | 6.75% | 0.701 |
...
- **Overall Best AUROC (#1 across ALL evaluated methods)**: Our VCPS methods achieve the highest selective prediction AUROC on **2 out of 14 datasets**.
  - **Specific Datasets Won in AUROC**: `ai2d` (VCPS-17D (Our Method): **0.706**), `lego-puzzles` (VCPS-5D (Our Method): **0.625**).
...
| `gqa` | Adaptive TS (ATS) | **7.59%** | Trajectory Platt (5D) | **0.763** | `Competitive` |
| `infographicvqa` | Spline Calibration | **0.27%** | Trajectory Platt (17D) | **0.945** | `Competitive` |
| `lego-puzzles` | Spline Calibration | **0.15%** | VCPS-5D (Our Method) | **0.625** | `Top AUROC` |
...
| `pope` | Trajectory LR | **3.85%** | Trajectory Platt (17D) | **0.826** | `Competitive` |
| `scienceqa` | Spline Calibration | **2.84%** | Trajectory LR | **0.783** | `Competitive` |
| `seedbench` | Spline Calibration | **3.37%** | Trajectory LR | **0.746** | `Competitive` |
