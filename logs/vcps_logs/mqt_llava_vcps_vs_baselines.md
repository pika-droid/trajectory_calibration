...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 10.84% | 10.86% | 0.689 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 9.24% | 11.50% | 0.405 | `COLLAPSED` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 2.25% | 3.69% | 0.693 | `COLLAPSED` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | **7.74%** | 11.15% | 0.756 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 0.84% | 1.76% | 0.503 | `COLLAPSED` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 7.24% | 8.34% | **0.611** | `SCRAMBLED` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 8.95% | 5.32% | **0.835** | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 1.07% | 2.28% | **0.738** | `COLLAPSED` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 4.55% | 6.80% | **0.820** | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 9.51% | 9.95% | **0.782** | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 7.13% | 11.78% | 0.724 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 7.03% | 7.19% | 0.745 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | *5.28%* | 6.28% | 0.776 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | *7.62%* | 7.12% | 0.771 | `VALID` |
...
| Trajectory LR (No Bias) | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 6.38% | 7.43% | 0.703 |
...
- **Overall Best ECE (#1 across ALL evaluated methods)**: Our VCPS methods (**VCPS-5D** / **VCPS-17D**) achieve the absolute lowest ECE on **1 out of 14 datasets** (7.1% win rate).
  - **Specific Datasets Won in ECE**: `docvqa` (VCPS-5D (Our Method): **0.24%**).
...
- **Overall Best AUROC (#1 across ALL evaluated methods)**: Our VCPS methods achieve the highest selective prediction AUROC on **1 out of 14 datasets**.
  - **Specific Datasets Won in AUROC**: `seedbench` (VCPS-17D (Our Method): **0.739**).
...
| `gqa` | Trajectory LR (No Bias) | **7.74%** | Adaptive TS (ATS) | **0.757** | `Competitive` |
| `infographicvqa` | Quadratic Platt (Logit-Only) | **0.28%** | Naive Confidence (NC) | **0.769** | `Competitive` |
| `lego-puzzles` | Platt Scaling (1D) | **0.60%** | Trajectory LR (No Bias) | **0.611** | `Competitive` |
| `mmbench` | Quadratic Platt (Logit-Only) | **3.87%** | Trajectory LR (No Bias) | **0.835** | `Competitive` |
| `mmmu` | Quadratic Platt (Logit-Only) | **0.12%** | Trajectory LR (No Bias) | **0.738** | `Competitive` |
| `pope` | Residual Calibrator | **3.75%** | Trajectory LR (No Bias) | **0.820** | `Competitive` |
| `scienceqa` | Quadratic Platt (Logit-Only) | **5.00%** | Trajectory LR (No Bias) | **0.782** | `Competitive` |
...
| `vizwiz-vqa` | Quadratic Platt (Logit-Only) | **4.92%** | Residual Calibrator | **0.803** | `Competitive` |
| `vqav2` | Quadratic Platt (Logit-Only) | **6.25%** | `umpire` | **0.790** | `Competitive` |
