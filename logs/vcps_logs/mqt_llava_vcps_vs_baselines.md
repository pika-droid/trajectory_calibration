...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 10.07% | 9.92% | 0.691 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 11.49% | 11.88% | 0.684 | `VALID` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 8.21% | 11.34% | **0.709** | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 7.21% | 11.04% | *0.709* | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *7.00%* | 8.52% | 0.707 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 3.52% | 6.32% | 0.745 | `SCRAMBLED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.75% | 12.11% | 0.414 | `COLLAPSED` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 1.76% | 5.96% | 0.589 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | **0.61%** | 6.95% | 0.508 | `COLLAPSED` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *0.66%* | 6.81% | 0.546 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 1.21% | 2.85% | 0.776 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 1.91% | 2.74% | 0.727 | `VALID` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 0.52% | 4.16% | 0.674 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *0.41%* | 4.15% | 0.673 | `COLLAPSED` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | **0.15%** | 3.57% | 0.684 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 10.32% | 13.04% | **0.762** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 11.42% | 13.01% | *0.761* | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | *9.13%* | 9.11% | 0.757 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 9.91% | 9.26% | 0.757 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 9.82% | 9.22% | 0.758 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | **8.05%** | 9.63% | 0.758 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 0.30% | 1.06% | **0.894** | `COLLAPSED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 0.40% | 1.30% | 0.573 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 2.34% | 7.96% | *0.610* | `SCRAMBLED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 4.07% | 6.20% | 0.609 | `SCRAMBLED` |
...
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 1.88% | 9.07% | 0.585 | `COLLAPSED` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *1.82%* | 10.69% | 0.579 | `COLLAPSED` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 2.93% | 11.80% | **0.613** | `SCRAMBLED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 7.52% | 5.98% | *0.841* | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 8.15% | 5.70% | **0.845** | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 9.37% | 9.87% | 0.831 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 8.57% | 7.52% | 0.831 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 7.94% | 6.84% | 0.833 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *6.05%* | 6.22% | 0.839 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | **0.08%** | 1.79% | *0.785* | `COLLAPSED` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 0.24% | 1.93% | **0.841** | `COLLAPSED` |
...
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 0.15% | 2.15% | 0.356 | `COLLAPSED` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.68% | 5.00% | **0.820** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 5.19% | 6.15% | 0.818 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 5.68% | 5.99% | 0.817 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | **4.04%** | 6.58% | 0.819 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 5.31% | 6.54% | *0.819* | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 5.72% | 5.43% | 0.818 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.65% | 6.16% | *0.783* | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 5.25% | 7.87% | 0.771 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 10.13% | 10.12% | 0.778 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 6.17% | 7.23% | 0.780 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 5.05% | 7.51% | 0.781 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | **4.44%** | 5.24% | **0.783** | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 8.00% | 8.56% | 0.736 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 10.39% | 7.91% | 0.730 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | **6.41%** | 8.99% | 0.735 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 7.51% | 8.32% | 0.733 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 8.25% | 10.95% | 0.736 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 9.58% | 7.64% | **0.739** | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 6.52% | 6.99% | 0.762 | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 7.81% | 8.03% | 0.749 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 18.16% | 18.16% | 0.692 | `COLLAPSED` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 6.88% | 6.67% | 0.713 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *6.42%* | 7.63% | 0.728 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 8.02% | 7.68% | 0.737 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 7.11% | 5.57% | **0.804** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 6.10% | 7.38% | 0.778 | `VALID` |
...
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 5.69% | 6.11% | *0.804* | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *5.49%* | 5.34% | 0.803 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 8.27% | 8.56% | **0.802** | `VALID` |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | *7.42%* | 10.53% | 0.787 | `VALID` |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 11.79% | 13.03% | 0.767 | `VALID` |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 11.29% | 15.08% | 0.751 | `VALID` |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 9.40% | 11.11% | 0.764 | `VALID` |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | 7.78% | 7.83% | 0.771 | `VALID` |
...
| Trajectory LR | Linear Trajectory Baseline | Single-Pass ($T=0.0$) | 5.47% | 6.41% | **0.772** |
| Trajectory LR (No Bias) | Linear Trajectory Baseline (Zero-Bias) | Single-Pass ($T=0.0$) | 6.33% | 7.34% | *0.721* |
...
| Adaptive TS (ATS) | Adaptive Calibrator | Single-Pass ($T=0.0$) | 23.22% | 23.70% | 0.685 |
| Residual Calibrator | Feature-Aided Calibrator | Single-Pass ($T=0.0$) | 5.25% | 7.22% | 0.706 |
| VCPS-5D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | *4.88%* | 7.29% | 0.699 |
| VCPS-17D (Our Method) | Proposed Trajectory Calibration | Single-Pass ($T=0.0$) | **4.74%** | 6.35% | 0.709 |
...
- **Overall Best ECE (#1 across ALL evaluated methods)**: Our VCPS methods (**VCPS-5D** / **VCPS-17D**) achieve the absolute lowest ECE on **4 out of 14 datasets** (28.6% win rate).
  - **Specific Datasets Won in ECE**: `chartqa` (VCPS-5D (Our Method): **0.61%**), `docvqa` (VCPS-17D (Our Method): **0.15%**), `gqa` (VCPS-17D (Our Method): **8.05%**), `scienceqa` (VCPS-17D (Our Method): **4.44%**).
...
- **Overall Best AUROC (#1 across ALL evaluated methods)**: Our VCPS methods achieve the highest selective prediction AUROC on **3 out of 14 datasets**.
  - **Specific Datasets Won in AUROC**: `lego-puzzles` (VCPS-17D (Our Method): **0.613**), `scienceqa` (VCPS-17D (Our Method): **0.783**), `seedbench` (VCPS-17D (Our Method): **0.739**).

### B. Detailed Win Breakdown Table
| Dataset | Lowest ECE Method | Best ECE (%) | Highest AUROC Method | Best AUROC | VCPS Win Status |
| :--- | :--- | :---: | :--- | :---: | :---: |
| `ai2d` | Quadratic Platt (Logit-Only) | **6.24%** | Residual Calibrator | **0.709** | `Competitive` |
| `chartqa` | VCPS-5D (Our Method) | **0.61%** | `umpire` | **0.861** | `Top ECE` |
| `docvqa` | VCPS-17D (Our Method) | **0.15%** | `umpire` | **0.853** | `Top ECE` |
| `gqa` | VCPS-17D (Our Method) | **8.05%** | Trajectory LR | **0.762** | `Top ECE` |
| `infographicvqa` | Quadratic Platt (Logit-Only) | **0.28%** | Trajectory LR | **0.894** | `Competitive` |
| `lego-puzzles` | Platt Scaling (1D) | **0.60%** | VCPS-17D (Our Method) | **0.613** | `Top AUROC` |
| `mmbench` | Quadratic Platt (Logit-Only) | **3.87%** | Trajectory LR (No Bias) | **0.845** | `Competitive` |
| `mmmu` | Trajectory LR | **0.08%** | Trajectory LR (No Bias) | **0.841** | `Competitive` |
| `pope` | Residual Calibrator | **4.04%** | Trajectory LR | **0.820** | `Competitive` |
| `scienceqa` | VCPS-17D (Our Method) | **4.44%** | VCPS-17D (Our Method) | **0.783** | `Top ECE, Top AUROC` |
| `seedbench` | Adaptive TS (ATS) | **6.41%** | VCPS-17D (Our Method) | **0.739** | `Top AUROC` |
