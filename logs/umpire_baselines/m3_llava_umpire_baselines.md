...
- **Top AUROC Method**: `umpire` achieves the highest average selective prediction AUROC (**0.698**).
- **Top Calibration Method**: `umpire` attains the lowest post-hoc Calibrated ECE (**17.34%**).
- **Top Correlation Method**: `umpire` demonstrates the strongest linear correlation (**0.468**) with model error probability.
