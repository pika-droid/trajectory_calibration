...
class HuggingfaceModel(BaseModel):
    ...
    def __init__(self, model_name, stop_sequences=None, max_new_tokens=None):
        ...
        if 'llama' in model_name.lower():
            ...
            if ('8b' in model_name or '7b' in model_name or '13b' in model_name) or eightbit:
    ...
    def predict(self, input_data, temperature, return_full=False):
        ...
        full_answer_strip = "".join(full_answer.split(" "))
        input_data_strip = "".join(input_data.split(" "))
        if full_answer_strip.startswith(input_data_strip):
