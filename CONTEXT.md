...
- **VCPS-5D**: Parsimonious subset binding 4 signatures (defaulting to top 4 importance-ranked signatures $\mathbf{z}_{1..4} = [x_2, \dots, x_5]$, or forward-stepwise selected signatures $\mathbf{z}_4$) into slope and intercept across 5-D input ($x_1 + \mathbf{z}_4$, 10 parameters total).
